  ...
  (color-theme-install
   '(color-theme-blue
     (
      ...
      (mouse-color . "sienna1"))
     (default ((t (:background "black" :foreground "#cafe12"))))
     (blue ((t (:foreground "blue"))))
     (bold ((t (:bold t))))
     (bold-italic ((t (:bold t))))
     (border-glyph ((t (nil))))
     (buffers-tab ((t (:background "black" :foreground "white"))))
     (font-lock-builtin-face ((t (:foreground "#cafe12"))))
     ...
     (font-lock-type-face ((t (:foreground "#cafe12"))))
     (font-lock-variable-name-face ((t (:foreground "#F1266F"))))

...
;;   Helvetica (included with Mac OS X)
...
(defun color-theme-topfunky ()
  ...
  (color-theme-install
   '(color-theme-topfunky
     ...
     (bold ((t (:bold t :foreground "#bbbbbb" :weight bold :family "Arial"))))
     ...
     (custom-face-tag-face ((t (:bold t :family "Helvetica" :weight bold :height 1.2))))
     (custom-group-tag-face ((t (:foreground "MediumAquamarine"))))
     (custom-group-tag-face-1 ((t (:bold t :family "Helvetica" :foreground "pink" :weight bold :height 1.2))))
     ...
     (gnus-emphasis-bold ((t (:bold t :foreground "greenyellow" :weight bold :family "Helvetica"))))
     (gnus-emphasis-bold-italic ((t (:italic t :bold t :foreground "OrangeRed1" :slant italic :weight bold :family "Helvetica"))))
     (gnus-emphasis-highlight-words ((t (:background "black" :foreground "khaki"))))
     (gnus-emphasis-italic ((t (:italic t :bold t :foreground "orange" :slant italic :weight bold :family "Helvetica"))))
     (gnus-emphasis-underline ((t (:foreground "greenyellow" :underline t))))
     (gnus-emphasis-underline-bold ((t (:bold t :foreground "khaki" :underline t :weight bold :family "Helvetica"))))
     (gnus-emphasis-underline-bold-italic ((t (:italic t :bold t :underline t :slant italic :weight bold :family "Helvetica"))))
     (gnus-emphasis-underline-italic ((t (:italic t :foreground "orange" :underline t :slant italic :family "Helvetica"))))
     ...
     (modeline-buffer-id ((t (:bold t :foreground "White" :weight bold :family "Helvetica"))))
     (modeline-inactive ((t (:background "#444444" :foreground "#505050"))))
     (modeline-mousable ((t (:bold t :background "dark olive green" :foreground "yellow green" :weight bold :family "Helvetica"))))
     (modeline-mousable-minor-mode ((t (:bold t :background "dark olive green" :foreground "wheat" :weight bold :family "Helvetica"))))
     ...
     (woman-bold-face ((t (:bold t :weight bold :family "Helvetica"))))
     (woman-italic-face ((t (:italic t :foreground "beige" :slant italic :family "Helvetica"))))

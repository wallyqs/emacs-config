...
(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tangotango
     ...
     (org-level-1 ((t (:bold t :foreground "#dfdfdf" :height 1.1))))
     ;; (org-level-2 ((t (:bold nil :foreground "#edd400" :height 1.2))))
     (org-level-2 ((t (:bold nil :foreground "#709070" :height 1.0))))
     ...
     (org-date ((t (:underline t :foreground "#f0dfaf"))))
     ;; (org-footnote  ((t (:underline t :foreground "magenta3"))))
     (org-footnote  ((t (:underline t :foreground "#f0dfaf"))))
